...
public class Demenagement extends AppCompatActivity {
    ...
    private class SendPost extends AsyncTask<String, Void,  HashMap<String,List<String>>> {
        ...
        protected  HashMap<String,List<String>> doInBackground(String... urls) {
            ...
            String parsedString = "";
            try {
                URL url = new URL("http://helpme.esy.es/dem");
        ...
        protected void onPostExecute(final HashMap<String,List<String>> result) {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent=new Intent(Demenagement.this,Affiche.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demenagement);
        listView =(ListView) findViewById(R.id.lv_dem);
